...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO muzakki (nama_muzakki, jumlah_tanggungan, keterangan) VALUES ('$nama', '$jumlah_tanggungan', '$keterangan')";
  $result = mysqli_query($mysqli, $sql);

  if ($result) {
    $_SESSION['flash_status'] = 'Success';
    $_SESSION['flash_message'] = 'Data muzakki berhasil ditambahkan.';
    header('location: index.php');
    exit();
  } else {
    $_SESSION['flash_status'] = 'Error';
    $_SESSION['flash_message'] = 'Data muzakki gagal ditambahkan.';
    header('location: index.php');
    exit();
  }
}
...
<head>
  ...
  <title>Menambahkan Data Muzakki</title>
    ...
    <main class="mx-auto p-4">
      <section class="bg-gray-900 relative shadow-md sm:rounded-lg">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          <h2 class="mb-4 text-xl font-bold text-white">Menambahkan Data Muzakki Baru</h2>
          <form name="muzakki_add" action="" method="POST">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div class="w-full">
                ...
                <input type="number" name="jumlah_tanggungan" id="jumlah_tanggungan" class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-green-500 focus:border-green-500" placeholder="Masukan jumlah tanggungan" required="">
              </div>
              <div class="sm:col-span-2">
                <label for="keterangan" class="block mb-2 text-sm font-medium text-white">Keterangan</label>
                <textarea id="keterangan" name="keterangan" rows="8" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-green-500 focus:border-green-500" placeholder="Masukan keterangan di sini"></textarea>
              </div>
            </div>
