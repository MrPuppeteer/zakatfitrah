...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO kategori_mustahik (nama_kategori, jumlah_hak) VALUES ('$nama', '$jumlah_hak')";
  $result = mysqli_query($mysqli, $sql);

  if ($result) {
    $_SESSION['flash_status'] = 'Success';
    $_SESSION['flash_message'] = 'Data kategori mustahik berhasil ditambahkan.';
    header('location: index.php');
    exit();
  } else {
    $_SESSION['flash_status'] = 'Error';
    $_SESSION['flash_message'] = 'Data kategori mustahik gagal ditambahkan.';
    header('location: index.php');
    exit();
  }
}
...
<head>
  ...
  <title>Menambahkan Data Kategori Mustahik</title>
    ...
    <main class="mx-auto p-4">
      <section class="bg-gray-900 relative shadow-md sm:rounded-lg">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          <h2 class="mb-4 text-xl font-bold text-white">Menambahkan Data Kategori Mustahik Baru</h2>
          <form name="muzakki_add" action="" method="POST">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              <div class="sm:col-span-2">
                ...
                <input type="text" name="nama" id="nama" class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-green-500 focus:border-green-500" placeholder="Masukan nama kategori" required="">
              </div>
              <div class="w-full">
                <label for="jumlah_hak" class="block mb-2 text-sm font-medium text-white">Jumlah Hak</label>
                <input step="0.01" type="number" name="jumlah_hak" id="jumlah_hak" class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-green-500 focus:border-green-500" placeholder="Masukan jumlah hak" required="">
              </div>
            </div>
