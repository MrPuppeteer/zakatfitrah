...
$result = mysqli_query($mysqli, "SELECT * FROM kategori_mustahik");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Master Data Kategori Mustahik</title>
      ...
      <div class="bg-gray-800 relative shadow-md sm:rounded-lg overflow-visible">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
          <div class="w-full md:w-1/2">
            <h1 class="text-xl font-bold leading-tight tracking-tight md:text-2xl text-white mb-4">Master Data Kategori Mustahik</h1>
          </div>
          ...
          <table class="w-full text-sm text-left text-gray-400">
            <thead class="text-xs uppercase bg-gray-700 text-gray-400">
              <tr>
                ...
                <th scope="col" class="px-4 py-3">Jumlah Hak</th>
            ...
            <tbody>
              ...
              ?>
                <tr class="border-b border-gray-700">
                  <td class="px-4 py-3"><?php echo $res['id_kategori'] ?></td>
                  <th scope="row" class="px-4 py-3 font-medium whitespace-nowrap text-white">
                    <?php echo $res['nama_kategori'] ?>
                  </th>
                  <td class="px-4 py-3"><?php echo $res['jumlah_hak'] ?></td>
                  <td class="px-4 py-3 flex items-center justify-end">
                    <button id="<?php echo $res['id_kategori'] ?>-dropdown-button" data-dropdown-toggle="<?php echo $res['id_kategori'] ?>-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center rounded-lg focus:outline-none text-gray-400 hover:text-gray-100" type="button">
                      <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                      </svg>
                    </button>
                    <div id="<?php echo $res['id_kategori'] ?>-dropdown" class="hidden z-10 w-44 rounded divide-y shadow bg-gray-700 divide-gray-600">
                      <ul class="py-1 text-sm text-gray-200" aria-labelledby="<?php echo $res['id_kategori'] ?>-dropdown-button">
                        <li>
                          <a href="./view.php?id=<?php echo $res['id_kategori'] ?>" class="block py-2 px-4 hover:bg-gray-600 hover:text-white">Tampilkan</a>
                        </li>
                        <li>
                          <a href="./edit.php?id=<?php echo $res['id_kategori'] ?>" class="block py-2 px-4 hover:bg-gray-600 hover:text-white">Edit</a>
                        </li>
                      </ul>
                      <div class="py-1">
                        <a href="./delete.php?id=<?php echo $res['id_kategori'] ?>" class="block py-2 px-4 text-sm hover:bg-gray-600 text-gray-200 hover:text-white">Hapus</a>
                      </div>
                    </div>
                  </td>
                </tr>
