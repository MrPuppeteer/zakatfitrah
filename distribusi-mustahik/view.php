...
<head>
  ...
  <title>Data Distribusi Zakat Fitrah Mustahik</title>
      ...
      <section class="bg-gray-900 relative shadow-md sm:rounded-lg">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          ...
          <dl class="flex items-center space-x-6">
            <div>
              <dt class="mb-2 font-semibold leading-none text-white">Kategori</dt>
              <dd class="mb-4 font-light sm:mb-5 text-gray-400"><?php echo $kategori ?></dd>
            </div>
            <div>
              <dt class="mb-2 font-semibold leading-none text-white">Hak</dt>
              <dd class="mb-4 font-light sm:mb-5 text-gray-400"><?php echo $hak ?></dd>
            </div>
          </dl>
