...
$result = mysqli_query($mysqli, "SELECT * FROM bayarzakat WHERE id_zakat='$id'");
...
while ($res = mysqli_fetch_array($result)) {
  ...
  if ($jenis_bayar === "beras") {
    $bayar = $res['bayar_beras'];
  } else if ($jenis_bayar === "uang") {
    $bayar = $res['bayar_uang'];
  }
}
    ...
    <main class="mx-auto p-4">
      <section class="bg-gray-900 relative shadow-md sm:rounded-lg">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
          <h2 class="mb-2 text-xl font-semibold leading-none md:text-2xl text-white"><?php echo $nama ?></h2>
          <p class="mb-4 text-xl font-extrabold leading-none md:text-2xl text-white">#<?php echo $id ?></p>
          <dl class="flex items-center space-x-6">
            <div>
              <dt class="mb-2 font-semibold leading-none text-white">Jumlah Tanggungan</dt>
              <dd class="mb-4 font-light sm:mb-5 text-gray-400"><?php echo $jumlah_tanggungan ?></dd>
            </div>
            <div>
              <dt class="mb-2 font-semibold leading-none text-white">Jumlah Tanggungan yang Dibayar</dt>
              <dd class="mb-4 font-light sm:mb-5 text-gray-400"><?php echo $jumlah_tanggunganyangdibayar ?></dd>
            </div>
          </dl>
          <dl class="flex items-center space-x-6">
            <div>
              <dt class="mb-2 font-semibold leading-none text-white">Jenis Pembayaran</dt>
              <dd class="mb-4 font-light sm:mb-5 text-gray-400"><?php if ($jenis_bayar === "beras") echo "Beras";
                                                                else echo "Uang"; ?></dd>
            </div>
            <div>
              <dt class="mb-2 font-semibold leading-none text-white">Nominal</dt>
              <dd class="mb-4 font-light sm:mb-5 text-gray-400"><?php if ($jenis_bayar === "beras") echo "$bayar" . " kg";
                                                                else echo "Rp. " . "$bayar"; ?></dd>
            </div>
          </dl>
          <div class="flex items-center space-x-4">
            <a href="./edit.php?id=<?php echo $id ?>" class="text-white inline-flex items-center focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-green-600 hover:bg-green-700 focus:ring-green-800">
            ...
            <a href="./delete.php?id=<?php echo $id ?>" class="inline-flex items-center text-white bg-red-500 hover:bg-red-600 focus:ring-red-900 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">
